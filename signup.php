                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['gender']) && isset($_POST['contact']) && isset($_POST['address']) && isset($_POST['username']) && isset($_POST['password'])) {
                        ...
                        if ($check_result && mysqli_num_rows($check_result) > 0) {
                            ...
                            if ($conn->query($sql) === TRUE) {
                                ...
                                $sql = "INSERT INTO useraccount (username, password, levelid, infoid, otp, is_verified, status) VALUES ('$username', '$encrypted', 3, '$info_id', '$code', 'No', 1)";
                                ...
                                if ($conn->query($sql) === TRUE) {
                                    ...
                                    document.addEventListener('DOMContentLoaded', function() {
                                        Swal.fire({
                                            position: 'center',
                                            icon: 'success',
                                            text: 'Email Verification has been sent. Please check your email.',
