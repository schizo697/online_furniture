                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="username" type="text"
                                            placeholder="Enter your username" value="<?php echo $row['username'] ?>" readonly>
                                    </div>
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" name="gender" type="text"
                                                placeholder="Enter your gender" value="<?php echo $row['gender'] ?>" readonly>
                                        </div>
                                        <div class="col-md-6">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="gender" type="text" placeholder="Enter your gender"
